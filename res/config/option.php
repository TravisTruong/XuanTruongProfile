...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    public $title = "Ngô Xuân Trường | Resources V5";
    public $description = "Hi my name is XuanTruong / A freelance / web developer / vexer";
    public $keywords = "xuantruong,web xuan truong,ngo xuan truong,xuantruongtv,travisturong,website travis truong,xuanturong home,profile xuantruong";
    public $favicon = "./res/v5/img/logo.jpg";
    public $namesite = "XUANTRUONG | HÔM";
    public $avatar = "./res/v5/img/avatar.gif";
    public $userName = ["Hello Everybody", "My name is Xuan Truong","Aka TravisTruong","I really like website design 🌭"];
    ...
    public $bio5 = "Ăn, ngủ,ỉa làm và chơi game 🎮";
    public $bio6 = "Kẻ khờ dại tin vào tình yêu ✨";
    public $SocialNetworks = [
        "facebook" => "https://www.facebook.com/bapxuantruonggg", // Thay link facebook
        "instagram" => "https://www.instagram.com/_xuantruong07/", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/@ngoxuantruong29", // Thay link tiktok
        "telegram" => "https://t.me/haivinhmoder" // Thay link telegram
    ];
...
class ThanhDieuLoveDays implements ThanhDieuConfigInterface {
    public $ConfigLove = [
        ...
        "name_male" => "Xuan Truong", // Thay tên của bạn
        //========================================================//
        ...
        "name_female" => "Có Cái Lồn Nè", // Thay tên đối phương
        //========================================================//

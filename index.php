...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://thuthuatnhanh.com/wp-content/uploads/2023/03/hinh-anh-kha-banh-trai-tim-582x580.jpg" alt="Ngo Xuan Truong">
    ...
    <footer id="footer">
        <span>
            <a href="https://www.facebook.com/bapxuantruonggg" target="_blank">&copy; Copyright&nbsp;XuanTruong 2024</a>
        </span>
    </footer>
